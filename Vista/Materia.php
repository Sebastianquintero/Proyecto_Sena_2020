        ...
        <body>
            <header>
             ...
             <div class="contenedor">
                <form action="../Controlador/materia.php" class="form" method="post">
                    <div class="form-header">
                        <h1 class="form-title">F<span>ormulario Materia</span></h1>
                    </div>
        
                    <!--  Fecha DE La Asignacion  -->
        
                    <label for="fechaasignacion" class="form-label">Nombre materia</label>
                    <input name="nombre-materia" type="text" id="fechaasignacion" class="form-input" placeholder="Escriba La Fecha De La Asignación">
        
                    <!--  Curso De La Asignacion  -->
        
                    <label for="cursoasignacion" class="form-label"> Horas semanales</label>
                    <input name="horas-materia" type="text" class="form-input" id="cursoasignacion" placeholder="Escriba Su Curso Asignado ">
