...
if(isset($_SESSION['usuario']['rol']) && $_SESSION['usuario']['rol']==='Profesor'){
			...
			<div class="contenedor">
				<form action="" class="form">
					<div class="form-header">
						<h1 class="form-title">F<span>ormulario Profesor</span></h1>
					</div>
					...
					<label for="documento" class="form-label"> NumeroDocumento:</label>
					<input type="text" class="form-input" id="documento" placeholder="Escriba Su Documento">
	   
					<!--  Cargo Del Admin  -->
	   
					<label for="especialidad" class="form-label"> EspecialidadProfe:</label>
					<input type="text" class="form-input" id="Especialidad" placeholder="Escriba Su Especialidad">
	   
					<!--  Estado Del Admin  -->
	   
					<label for="estado" class="form-label"> Estado:</label>
					<input type="text" class="form-input" id="estado" placeholder="Escriba Su Estado">
